                ...
                <div className="hero__canvas">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1640 1251" preserveAspectRatio="xMidYMid meet">
                        ...
                        <g fill="none" fillRule="evenodd">
                            <image id="carpet" width="1640" height="1209" xlinkHref={require('../images/hali.png')}/>
                            <image id="kagit-dolu-1" style={{display:"none"}} width="125" height="75" xlinkHref={require('../images/kagıt_dolu1.png')}/>
                            <image id="kagit-bos-1"  className="empty-paper" style={{display:"none"}} width="125" height="75" xlinkHref={require('../images/kagıt_bos1.png')}/>
                            <image id="platform" width="1640" height="1251" xlinkHref={require('../images/platform.png')}/>
                            <g id="simsek1">
                            ...
                            <image id="platform-maske" width="1640" height="1251" xlinkHref={require('../images/pmaske.png')}/>
                        </g>
                    </svg>
                </div>
            </section>
