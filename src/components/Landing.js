...
class Landing extends React.Component{
    ...
    paperFactory()
    {
        let platform = document.getElementById("carpet");
        ...
        simsek3.parentNode.insertBefore(Papers["filled-paper-"+id].element,simsek3.nextSibling);
        ...
        return (
            ...
            <section id="hero">
                <div className="hero__wrapper">
                    ...
                    <a className="hero__btn-start" href="javascript:;" >Start now</a>
                </div>
                ...
                <div className="hero__canvas">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1640 1251" preserveAspectRatio="xMidYMid meet">
                        ...
                        <g fill="none" fillRule="evenodd">
                            <image id="carpet" width="1640" height="1209" href="./img/hali.png"/>
                            <image id="kagit-dolu-1" style={{display:"none"}} width="125" height="75" href="./img/kagıt_dolu1.png"/>
                            <image id="kagit-bos-1"  className="empty-paper" style={{display:"none"}} width="125" height="75" href="./img/kagıt_bos1.png"/>
                            <image id="platform" width="1640" height="1251" href="./img/platform.png"/>
                            <g id="simsek1">
                            ...
                            <image id="beyin" width="250" height="150" href="./img/beyin.png"/>
                            <g id="simsek2">
                            ...
                            <image id="platform-maske" width="1640" height="1251" href="./img/pmaske.png"/>
                        </g>
                    </svg>
                </div>
            </section>
